...
路径：`src/cnequity/adapters/macro/`
...
重试 / 限速 / TLS 处理。见 [issue #3](https://github.com/rootSunc/CNEquity/issues/3)。
...
[issue #10](https://github.com/rootSunc/CNEquity/issues/10) 补上了这一步：
