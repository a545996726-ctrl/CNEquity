...
def _filter_instrument_frame(pdf: pl.DataFrame, exch: str) -> pl.DataFrame:
    ...
    if "pre_close" in pdf.columns:
        ...
        # Keep nulls for alternate clients/fixtures that do not populate this
        # optional field. TDX's explicit sub-tick sentinel means the security
        # is advertised but not listed/tradable.
        mask = mask & (
